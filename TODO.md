...
- Discord user `Mopop#8020` for answering many questions and gathering resources. Also tested defense stacking (Reforço de Defesa  and Fortify along with Armorcharm/talon).
